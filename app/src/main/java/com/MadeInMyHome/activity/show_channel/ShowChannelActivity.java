package com.MadeInMyHome.activity.show_channel;
...
import com.MadeInMyHome.databinding.ActivityShowChannelBinding;
...
public class ShowChannelActivity extends AppCompatActivity {
    ...
    ActivityShowChannelBinding binding;

    public static Intent newIntent(Context context, Channel channel) {
        final Intent intent = new Intent(context, ShowChannelActivity.class);
