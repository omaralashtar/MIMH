...
public class MyCourseViewModel extends ViewModel {
    ...
    public MutableLiveData<ArrayList<Course>> showMyCourse(final Context context,String id,String next) {

        final MutableLiveData<ArrayList<Course>> arrayListMutableLiveData = new MutableLiveData<>();

        Call<CourseArrayListResponse> call = RestClient.getService().getAllEnroll(id,next);
